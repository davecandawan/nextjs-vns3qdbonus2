...
const FooterModal: React.FC<FooterModalProps> = ({ modalId, closeModal }) => {
  ...
  // Add animation classes based on modal state
  const modalClasses = `fixed inset-0 z-50 flex items-start justify-center pt-16 px-4 pb-4 overflow-y-auto transition-all duration-300 ease-out transform ${modalId ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4'}`;
